...
(0, typeorm_1.createConnection)().then(function (db) {
    var productRespository = db.getRepository(product_1.Product);
    amqp.connect('amqps://avtfmtry:hVNcvxdjHsKRnv1DCwrDNri8_Y3OITO6@baboon.rmq.cloudamqp.com/avtfmtry', function (error0, connecction) {
        if (error0) {
            throw error0;
        }
        connecction.createChannel(function (error1, channel) {
            var app = express();
            app.use(cors({
            ...
            app.post('/api/products', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, productRespository.create(req.body)];
                        case 1:
                            product = _a.sent();
                            return [4 /*yield*/, productRespository.save(product)];
                        case 2:
                            result = _a.sent();
                            channel.sendToQueue('product_created', buffer_1.Buffer.from(JSON.stringify(result)));
            ...
            app.put('/api/products/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            result = _a.sent();
                            channel.sendToQueue('product_updated', buffer_1.Buffer.from(JSON.stringify(result)));
            ...
            app.delete('/api/products/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            product = _a.sent();
                            return [4 /*yield*/, productRespository.delete(product)];
                        case 2:
                            result = _a.sent();
                            channel.sendToQueue('product_deleted', buffer_1.Buffer.from(req.params.id));
                            return [2 /*return*/, res.json(result)];
                    }
                });
            }); });
